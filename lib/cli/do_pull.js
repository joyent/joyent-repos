            ...
            funcs: [
                ...
                function execInThem(ctx, next) {
                    ...
                    var execer = jrm.execInClones({
                        ...
                        baseDir: baseDir,
                        cmd: cmd,
                        // IME, concurrency of 10 results in lots of SSH issues:
                        //    ssh_exchange_identification: read: Operation timed out
                        //    fatal: Could not read from remote repository.
                        //
                        //    Please make sure you have the correct access rights
                        //    and the repository exists.
                        // TODO: just the poor internet I was on? Something else?
...
do_pull.options = [
    ...
    },
    {
        ...
        helpArg: 'NUM',
        default: 10,
        help: 'Number of repos to operator on concurrently. Default 10.'
    },
    {
        group: ''
    },
...
do_pull.synopses = ['{{name}} {{cmd}} [OPTIONS] CMD [REPOS...]'];

do_pull.completionArgtypes = ['default', 'repopattern'];
